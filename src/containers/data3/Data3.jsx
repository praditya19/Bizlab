    ...
    <div className={classes.root}>
      ...
      <Container style={{ background: "#efefef" }} maxWidth="lg">
        <main>
          ...
          <Container>
            <Grid container spacing={5} s className={classes.mainGrid}>
                ...
                {value === 0 && (
                  <TabContainer>
                    ...
                    <ul className={classes.detail}>
                      <li>Definisi analisis data (00.00 - 01.10)</li>
                      <li>Apa itu SPSS (01.10 - 01.41)</li>
                      <li>
                        Kombinasi Lean Startup dan Statistika (01.41- 02.40)
                      </li>
                      <li>Riset kuantitatif (00.00 - 01.35)</li>
                      <li>Validitas Data (01.35 - 03.50)</li>
                      <li>Cara menguji hasil (03.50 - 04.14)</li>
                      <li>Pengaplikasian SPSS (00.00 - 09.19)</li>
                    </ul>
                    {""}
                    <h4 className={classes.judul} gutterBottom>
                      About Class
                    ...
                    <p className={classes.detail}>
                      Saat ini, masih banyak orang yang kurang mengerti
                      pentingnya sebuah data, dan bagaimana proses
                      pengolahannya. Padahal data merupakan salah satu hal yang
                      sangat penting untuk membantu kamu mengetahui market yang
                      menjadi sasaran dalam dunia bisnis. Analisis data sendiri
                      bisa mempermudah kamu dalam pendataan serta klasifikasi
                      market yang lebih jelas serta teliti bukan hanya itu, hal
                      ini memudahkan dalam meluncurkan ide yang baru yang dirasa
                      pas untuk target market yang didapat dari hasil analisis
                      data yang dilakukan. Maka dari itu, dengan menonton video
                      dari Bizlab ini kamu akan mempelajari bagaimana cara untuk
                      menganalisis data dan cara mengolahnya untuk
                    </p>
                  </TabContainer>
                )}
                {value === 1 && (
              ...
              <Grid item xs={12} md={4}>
                <Paper elevation={0} className={classes.sidebarAboutBox}>
                  <h5>Belajar Analisa Data dengan SPSS</h5>
                  {""}
                  <p className={classes.p}>By Erna Fransiska</p>
                  <hr />
